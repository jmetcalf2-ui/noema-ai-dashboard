  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        <Link href="/files">
          <Card className="hover:border-primary/50 transition-colors cursor-pointer group relative overflow-hidden" data-testid="card-new-analysis">
        ...
        {/* Browse Analyses | Manage Files - 50/50 Split */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/analyses">
            <Card className="p-4 hover:bg-secondary/50 transition-all cursor-pointer group h-full" data-testid="card-browse-analyses">
          ...
          <Link href="/files">
            <Card className="p-4 hover:bg-secondary/50 transition-all cursor-pointer group h-full" data-testid="card-manage-files">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-md bg-secondary flex items-center justify-center">
            ...
            <div className="divide-y divide-border/50">
              {analyses.slice(0, 5).map((analysis: any) => (
                <Link key={analysis.id} href={`/analyses/${analysis.id}`}>
                  <div className="flex items-center justify-between p-4 hover:bg-muted/30 transition-colors cursor-pointer group" data-testid={`row-analysis-${analysis.id}`}>
      ...
      {/* Pro Tip & System Status - Full Width Stacked */}
      <div className="space-y-4">
